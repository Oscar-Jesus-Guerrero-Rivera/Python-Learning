"""
Assignment
Complete the get_filter_cmd function. It takes two functions as input, filter_one and filter_two,
...
The filter_cmd should filter and return the content according to the input option. 
Do not use the builtin filter function.
